...
zotlook-prefs-contactsheet-menustay-help = Ein Menü bleibt offen, nachdem einem Eintrag gefolgt wurde, damit der nächste einen Klick oder ein Enter entfernt ist. Ohne Häkchen klappt es beim Sprung zu, damit die Seite zu sehen ist.
zotlook-prefs-contactsheet-menustay-mouse =
    .label = Menü nach einem Klick auf einen Eintrag offen lassen
zotlook-prefs-contactsheet-menustay-keyboard =
    .label = Menü nach Enter auf einem Eintrag offen lassen
...
# Seitenleisten-Knopfs und die drei Knöpfe darin
zotlook-pane-header =
    .label = zotLook
